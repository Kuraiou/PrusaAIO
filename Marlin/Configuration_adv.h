...
#define PRUSA_AIO_VERSION 20240209
 ...
 */
#define FAN_MIN_PWM PRUSA_AIO_FAN_MIN_PWM
 ...
 */
#define E0_AUTO_FAN_PIN PRUSA_AIO_E0_AUTO_FAN_PIN
...
//#define INPUT_SHAPING_Y
    ...
    #define SHAPING_FREQ_X PRUSA_AIO_SHAPING_FREQ_X  // (Hz) The default dominant resonant frequency on the X axis.
    #define SHAPING_ZETA_X PRUSA_AIO_SHAPING_ZETA_X  // Damping ratio of the X axis (range: 0.0 = no damping to 1.0 = critical damping).
  #endif
  #if ENABLED(INPUT_SHAPING_Y)
    #define SHAPING_FREQ_Y PRUSA_AIO_SHAPING_FREQ_Y  // (Hz) The default dominant resonant frequency on the Y axis.
    #define SHAPING_ZETA_Y PRUSA_AIO_SHAPING_ZETA_Y  // Damping ratio of the Y axis (range: 0.0 = no damping to 1.0 = critical damping).
  #endif
...
//#define BEEP_ON_FEEDRATE_CHANGE
  ...
  //#define LED_CONTROL_MENU
    ...
    //#define NEO2_COLOR_PRESETS              // Enable a second NeoPixel Preset Color menu option
      ...
      #define LED_USER_PRESET_RED   PRUSA_AIO_LED_USER_PRESET_RED   // User defined RED value
      #define LED_USER_PRESET_GREEN PRUSA_AIO_LED_USER_PRESET_GREEN // User defined GREEN value
      #define LED_USER_PRESET_BLUE  PRUSA_AIO_LED_USER_PRESET_BLUE  // User defined BLUE value
      #define LED_USER_PRESET_WHITE PRUSA_AIO_LED_USER_PRESET_WHITE // User defined WHITE value
      #define LED_USER_PRESET_BRIGHTNESS 255  // User defined intensity
      #define LED_USER_PRESET_STARTUP       // Have the printer display the user preset color on startup
    #endif
    #if ENABLED(NEO2_COLOR_PRESETS)
      #define NEO2_USER_PRESET_RED   PRUSA_AIO_NEO2_USER_PRESET_RED   // User defined RED value
      #define NEO2_USER_PRESET_GREEN PRUSA_AIO_NEO2_USER_PRESET_GREEN // User defined GREEN value
      #define NEO2_USER_PRESET_BLUE  PRUSA_AIO_NEO2_USER_PRESET_BLUE  // User defined BLUE value
      #define NEO2_USER_PRESET_WHITE PRUSA_AIO_NEO2_USER_PRESET_WHITE // User defined WHITE value
...
// LCD Print Progress options. Multiple times may be displayed in turn.
   ...
   */
  #define SDCARD_CONNECTION PRUSA_AIO_SDCARD_CONNECTION
 ...
 */
  ...
  #define INTERPOLATE      true
    ...
    #define X_CURRENT        PRUSA_AIO_X_CURRENT       // (mA) RMS current. Multiply by 1.414 for peak current.
    #define X_CURRENT_HOME   PRUSA_AIO_X_CURRENT_HOME  // (mA) RMS current for sensorless homing
    #define X_MICROSTEPS     16        // 0..256
    #define X_RSENSE         PRUSA_AIO_DRIVER_RSENSE   // Multiplied x1000 for TMC26X
    ...
    #define Y_CURRENT       PRUSA_AIO_Y_CURRENT
    #define Y_CURRENT_HOME  PRUSA_AIO_Y_CURRENT_HOME
    #define Y_MICROSTEPS     16
    #define Y_RSENSE         PRUSA_AIO_DRIVER_RSENSE
    ...
    #define Z_RSENSE         PRUSA_AIO_DRIVER_RSENSE
    ...
    #define Z2_RSENSE       PRUSA_AIO_DRIVER_RSENSE
    ...
    #define E0_CURRENT     PRUSA_AIO_E0_CURRENT
    #define E0_MICROSTEPS  PRUSA_AIO_E0_MICROSTEPS
    #define E0_RSENSE      PRUSA_AIO_DRIVER_RSENSE
  ...
  #define CHOPPER_TIMING_X PRUSA_AIO_CHOPPER_TIMING_X // For X Axes (override below)
  //#define CHOPPER_TIMING_X2 CHOPPER_TIMING_X
  #define CHOPPER_TIMING_Y PRUSA_AIO_CHOPPER_TIMING_Y // For Y Axes (override below)
  //#define CHOPPER_TIMING_Y2 CHOPPER_TIMING_Y
  #define CHOPPER_TIMING_Z PRUSA_AIO_CHOPPER_TIMING_Z // For Z Axes (override below)
  ...
  #define CHOPPER_TIMING_E PRUSA_AIO_CHOPPER_TIMING_E  // For Extruders (override below)
...
//#define CUSTOM_MENU_MAIN
  ...
  #define CUSTOM_MENU_MAIN_TITLE "Calibration"
  //#define CUSTOM_MENU_MAIN_SCRIPT_DONE "M117 Completed"
  #define CUSTOM_MENU_MAIN_SCRIPT_AUDIBLE_FEEDBACK
  #define CUSTOM_MENU_MAIN_SCRIPT_RETURN   // Return to status screen after a script
  #define CUSTOM_MENU_MAIN_ONLY_IDLE         // Only show custom menu when the machine is idle

  // Based on Prusa's "meander" first layer calibration: https://github.com/prusa3d/Prusa-Firmware/blob/MK3/Firmware/first_lay_cal.cpp
  #define Z_CAL_DESC " Z Calibration"
  #define Z_CAL_PRE_UBL "G28\nM107\nG29 L1\nG29 J2\nG0 X2.0 Y-2.0 Z0.60 F3000\nM140 S"
  #define Z_CAL_PRE_ABL "G28\nM107\nM140 S"
  ...
  #define MAIN_MENU_ITEM_1_DESC "Nozzle Change"
  #define MAIN_MENU_ITEM_1_GCODE "G28\nG0 Z140 F2000\nM104 S275\nM117 Heating to 275C\nG4 s10\nM0 Click when finished...\nM104 S0"
  #define MAIN_MENU_ITEM_1_CONFIRM

  #define MAIN_MENU_ITEM_2_DESC "Full Calibration"
  #define MAIN_MENU_ITEM_2_GCODE "M140 S60\nM190 S60\nG28\nG34\nG29\nM500\nM140 S0\nG28"
  #define MAIN_MENU_ITEM_2_CONFIRM

  #define MAIN_MENU_ITEM_3_DESC "Auto Cold Pull"
  #define MAIN_MENU_ITEM_3_GCODE "G28\nM83\nG92 E0.00\nG21\nG0 Z30\nM109 S250\nG1 E10.00 F6.5\nM109 S95\nM18 E\nM0 Remove filament...\nM106 S0\nM104 S0"
  #define MAIN_MENU_ITEM_3_CONFIRM

  #if ENABLED(PRUSA_AIO_BED_LEVELING_BILINEAR)
    #define MAIN_MENU_ITEM_4_DESC PREHEAT_1_LABEL Z_CAL_DESC
    #define MAIN_MENU_ITEM_4_GCODE Z_CAL_PRE_ABL STRINGIFY(PREHEAT_1_TEMP_BED) "\nM190 S" STRINGIFY(PREHEAT_1_TEMP_BED) "\nM104 S160\nM109 S160\nG29\nG1 X2.0 Y-2.0 Z0.60\nM104 S" STRINGIFY(PREHEAT_1_TEMP_HOTEND) "\nM109 S" STRINGIFY(PREHEAT_1_TEMP_HOTEND) Z_CAL_END
    #define MAIN_MENU_ITEM_4_CONFIRM

    #define MAIN_MENU_ITEM_5_DESC PREHEAT_2_LABEL Z_CAL_DESC
    #define MAIN_MENU_ITEM_5_GCODE Z_CAL_PRE_ABL STRINGIFY(PREHEAT_2_TEMP_BED) "\nM190 S" STRINGIFY(PREHEAT_2_TEMP_BED) "\nM104 S160\nM109 S160\nG29\nG1 X2.0 Y-2.0 Z0.60\nM104 S" STRINGIFY(PREHEAT_2_TEMP_HOTEND) "\nM109 S" STRINGIFY(PREHEAT_2_TEMP_HOTEND) Z_CAL_END
    #define MAIN_MENU_ITEM_5_CONFIRM

    #define MAIN_MENU_ITEM_6_DESC PREHEAT_3_LABEL Z_CAL_DESC
    #define MAIN_MENU_ITEM_6_GCODE Z_CAL_PRE_ABL STRINGIFY(PREHEAT_3_TEMP_BED) "\nM190 S" STRINGIFY(PREHEAT_3_TEMP_BED) "\nM104 S160\nM109 S160\nG29\nG1 X2.0 Y-2.0 Z0.60\nM104 S" STRINGIFY(PREHEAT_3_TEMP_HOTEND) "\nM109 S" STRINGIFY(PREHEAT_3_TEMP_HOTEND) Z_CAL_END
    #define MAIN_MENU_ITEM_6_CONFIRM

    #define MAIN_MENU_ITEM_7_DESC PREHEAT_4_LABEL Z_CAL_DESC
    #define MAIN_MENU_ITEM_7_GCODE Z_CAL_PRE_ABL STRINGIFY(PREHEAT_4_TEMP_BED) "\nM190 S" STRINGIFY(PREHEAT_4_TEMP_BED) "\nM104 S160\nM109 S160\nG29\nG1 X2.0 Y-2.0 Z0.60\nM104 S" STRINGIFY(PREHEAT_4_TEMP_HOTEND) "\nM109 S" STRINGIFY(PREHEAT_4_TEMP_HOTEND) Z_CAL_END
    #define MAIN_MENU_ITEM_7_CONFIRM

    #define MAIN_MENU_ITEM_8_DESC PREHEAT_5_LABEL Z_CAL_DESC
    #define MAIN_MENU_ITEM_8_GCODE Z_CAL_PRE_ABL STRINGIFY(PREHEAT_5_TEMP_BED) "\nM190 S" STRINGIFY(PREHEAT_5_TEMP_BED) "\nM104 S160\nM109 S160\nG29\nG1 X2.0 Y-2.0 Z0.60\nM104 S" STRINGIFY(PREHEAT_5_TEMP_HOTEND) "\nM109 S" STRINGIFY(PREHEAT_5_TEMP_HOTEND) Z_CAL_END
    #define MAIN_MENU_ITEM_8_CONFIRM

    #define MAIN_MENU_ITEM_9_DESC PREHEAT_6_LABEL Z_CAL_DESC
    #define MAIN_MENU_ITEM_9_GCODE Z_CAL_PRE_ABL STRINGIFY(PREHEAT_6_TEMP_BED) "\nM190 S" STRINGIFY(PREHEAT_6_TEMP_BED) "\nM104 S160\nM109 S160\nG29\nG1 X2.0 Y-2.0 Z0.60\nM104 S" STRINGIFY(PREHEAT_6_TEMP_HOTEND) "\nM109 S" STRINGIFY(PREHEAT_6_TEMP_HOTEND) Z_CAL_END
    #define MAIN_MENU_ITEM_9_CONFIRM

    #define MAIN_MENU_ITEM_10_DESC PREHEAT_7_LABEL Z_CAL_DESC
    #define MAIN_MENU_ITEM_10_GCODE Z_CAL_PRE_ABL STRINGIFY(PREHEAT_7_TEMP_BED) "\nM190 S" STRINGIFY(PREHEAT_7_TEMP_BED) "\nM104 S160\nM109 S160\nG29\nG1 X2.0 Y-2.0 Z0.60\nM104 S" STRINGIFY(PREHEAT_7_TEMP_HOTEND) "\nM109 S" STRINGIFY(PREHEAT_7_TEMP_HOTEND) Z_CAL_END
    #define MAIN_MENU_ITEM_10_CONFIRM

    #define MAIN_MENU_ITEM_11_DESC PREHEAT_8_LABEL Z_CAL_DESC
    #define MAIN_MENU_ITEM_11_GCODE Z_CAL_PRE_ABL STRINGIFY(PREHEAT_8_TEMP_BED) "\nM190 S" STRINGIFY(PREHEAT_8_TEMP_BED) "\nM104 S160\nM109 S160\nG29\nG1 X2.0 Y-2.0 Z0.60\nM104 S" STRINGIFY(PREHEAT_8_TEMP_HOTEND) "\nM109 S" STRINGIFY(PREHEAT_8_TEMP_HOTEND) Z_CAL_END
    #define MAIN_MENU_ITEM_11_CONFIRM

    #define MAIN_MENU_ITEM_12_DESC PREHEAT_9_LABEL Z_CAL_DESC
    #define MAIN_MENU_ITEM_12_GCODE Z_CAL_PRE_ABL STRINGIFY(PREHEAT_9_TEMP_BED) "\nM190 S" STRINGIFY(PREHEAT_9_TEMP_BED) "\nM104 S160\nM109 S160\nG29\nG1 X2.0 Y-2.0 Z0.60\nM104 S" STRINGIFY(PREHEAT_9_TEMP_HOTEND) "\nM109 S" STRINGIFY(PREHEAT_9_TEMP_HOTEND) Z_CAL_END
    #define MAIN_MENU_ITEM_12_CONFIRM

    #define MAIN_MENU_ITEM_13_DESC "Reset EEPROM"
    #define MAIN_MENU_ITEM_13_GCODE "M502\nM500"
    #define MAIN_MENU_ITEM_13_CONFIRM
  #elif ENABLED(PRUSA_AIO_BED_LEVELING_UBL)
    #define MAIN_MENU_ITEM_4_DESC PREHEAT_1_LABEL Z_CAL_DESC
    #define MAIN_MENU_ITEM_4_GCODE Z_CAL_PRE_UBL STRINGIFY(PREHEAT_1_TEMP_BED) "\nM104 S" STRINGIFY(PREHEAT_1_TEMP_HOTEND) "\nM190 S" STRINGIFY(PREHEAT_1_TEMP_BED) "\nM109 S" STRINGIFY(PREHEAT_1_TEMP_HOTEND) Z_CAL_END
    #define MAIN_MENU_ITEM_4_CONFIRM

    #define MAIN_MENU_ITEM_5_DESC PREHEAT_2_LABEL Z_CAL_DESC
    #define MAIN_MENU_ITEM_5_GCODE Z_CAL_PRE_UBL STRINGIFY(PREHEAT_2_TEMP_BED) "\nM104 S" STRINGIFY(PREHEAT_2_TEMP_HOTEND) "\nM190 S" STRINGIFY(PREHEAT_2_TEMP_BED) "\nM109 S" STRINGIFY(PREHEAT_2_TEMP_HOTEND) Z_CAL_END
    #define MAIN_MENU_ITEM_5_CONFIRM

    #define MAIN_MENU_ITEM_6_DESC PREHEAT_3_LABEL Z_CAL_DESC
    #define MAIN_MENU_ITEM_6_GCODE Z_CAL_PRE_UBL STRINGIFY(PREHEAT_3_TEMP_BED) "\nM104 S" STRINGIFY(PREHEAT_3_TEMP_HOTEND) "\nM190 S" STRINGIFY(PREHEAT_3_TEMP_BED) "\nM109 S" STRINGIFY(PREHEAT_3_TEMP_HOTEND) Z_CAL_END
    #define MAIN_MENU_ITEM_6_CONFIRM

    #define MAIN_MENU_ITEM_7_DESC PREHEAT_4_LABEL Z_CAL_DESC
    #define MAIN_MENU_ITEM_7_GCODE Z_CAL_PRE_UBL STRINGIFY(PREHEAT_4_TEMP_BED) "\nM104 S" STRINGIFY(PREHEAT_4_TEMP_HOTEND) "\nM190 S" STRINGIFY(PREHEAT_4_TEMP_BED) "\nM109 S" STRINGIFY(PREHEAT_4_TEMP_HOTEND) Z_CAL_END
    #define MAIN_MENU_ITEM_7_CONFIRM

    #define MAIN_MENU_ITEM_8_DESC PREHEAT_5_LABEL Z_CAL_DESC
    #define MAIN_MENU_ITEM_8_GCODE Z_CAL_PRE_UBL STRINGIFY(PREHEAT_5_TEMP_BED) "\nM104 S" STRINGIFY(PREHEAT_5_TEMP_HOTEND) "\nM190 S" STRINGIFY(PREHEAT_5_TEMP_BED) "\nM109 S" STRINGIFY(PREHEAT_5_TEMP_HOTEND) Z_CAL_END
    #define MAIN_MENU_ITEM_8_CONFIRM

    #define MAIN_MENU_ITEM_9_DESC PREHEAT_6_LABEL Z_CAL_DESC
    #define MAIN_MENU_ITEM_9_GCODE Z_CAL_PRE_UBL STRINGIFY(PREHEAT_6_TEMP_BED) "\nM104 S" STRINGIFY(PREHEAT_6_TEMP_HOTEND) "\nM190 S" STRINGIFY(PREHEAT_6_TEMP_BED) "\nM109 S" STRINGIFY(PREHEAT_6_TEMP_HOTEND) Z_CAL_END
    #define MAIN_MENU_ITEM_9_CONFIRM

    #define MAIN_MENU_ITEM_10_DESC PREHEAT_7_LABEL Z_CAL_DESC
    #define MAIN_MENU_ITEM_10_GCODE Z_CAL_PRE_UBL STRINGIFY(PREHEAT_7_TEMP_BED) "\nM104 S" STRINGIFY(PREHEAT_7_TEMP_HOTEND) "\nM190 S" STRINGIFY(PREHEAT_7_TEMP_BED) "\nM109 S" STRINGIFY(PREHEAT_7_TEMP_HOTEND) Z_CAL_END
    #define MAIN_MENU_ITEM_10_CONFIRM

    #define MAIN_MENU_ITEM_11_DESC PREHEAT_8_LABEL Z_CAL_DESC
    #define MAIN_MENU_ITEM_11_GCODE Z_CAL_PRE_UBL STRINGIFY(PREHEAT_8_TEMP_BED) "\nM104 S" STRINGIFY(PREHEAT_8_TEMP_HOTEND) "\nM190 S" STRINGIFY(PREHEAT_8_TEMP_BED) "\nM109 S" STRINGIFY(PREHEAT_8_TEMP_HOTEND) Z_CAL_END
    #define MAIN_MENU_ITEM_11_CONFIRM

    #define MAIN_MENU_ITEM_12_DESC PREHEAT_9_LABEL Z_CAL_DESC
    #define MAIN_MENU_ITEM_12_GCODE Z_CAL_PRE_UBL STRINGIFY(PREHEAT_9_TEMP_BED) "\nM104 S" STRINGIFY(PREHEAT_9_TEMP_HOTEND) "\nM190 S" STRINGIFY(PREHEAT_9_TEMP_BED) "\nM109 S" STRINGIFY(PREHEAT_9_TEMP_HOTEND) Z_CAL_END
    #define MAIN_MENU_ITEM_12_CONFIRM

    #define MAIN_MENU_ITEM_13_DESC "UBL Mesh Wizard"
    #define MAIN_MENU_ITEM_13_GCODE "M1004"
    #define MAIN_MENU_ITEM_13_CONFIRM

    #define MAIN_MENU_ITEM_14_DESC "Adjust Point Near"
    #define MAIN_MENU_ITEM_14_GCODE "G29 P4\nM500"
    #define MAIN_MENU_ITEM_14_CONFIRM

    #define MAIN_MENU_ITEM_15_DESC "Reset EEPROM"
    #define MAIN_MENU_ITEM_15_GCODE "M502\nM500"
...
//#define CUSTOM_MENU_CONFIG
  ...
  #define CUSTOM_MENU_CONFIG_TITLE "Sheet Profiles"
  #define CUSTOM_MENU_CONFIG_SCRIPT_DONE "M500\nM117 Sheet Loaded"
