...
#define PTC_BED
...
#if ANY(PRUSA_AIO_EXTRUDER_BEAR_BLTOUCH, PRUSA_AIO_EXTRUDER_BMG_BLTOUCH)
  #define BLTOUCH
  ...
  #define PRUSA_AIO_Z_CLEARANCE_MULTI_PROBE    3
    ...
    #if ENABLED(PRUSA_AIO_EXTRUDER_BEAR_BLTOUCH)
...
#elif ANY(PRUSA_AIO_EXTRUDER_BEAR_PINDA, PRUSA_AIO_EXTRUDER_BMG_PINDA)
...
//===========================================================================
  ...
  #define MPCTEMP
    ...
    #define PRUSA_AIO_CUSTOM_FILAMENT_HEAT_CAPACITY_PERMM  { 5.6e-3f }
  #endif
#else
  #define PIDTEMP
...
//TODO: Test all fan/board combos
  ...
  #elif ANY(PRUSA_AIO_MOTHERBOARD_MKS_SGEN_L_V2, PRUSA_AIO_MOTHERBOARD_BTT_SKR_1_4, PRUSA_AIO_MOTHERBOARD_BTT_SKR_1_4_TURBO)
